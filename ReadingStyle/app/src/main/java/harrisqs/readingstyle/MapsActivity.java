...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityName = intent.getStringArrayListExtra("cityName");
        address = intent.getStringArrayListExtra("address");
        longitude = intent.getStringArrayListExtra("longitude");
    ...
    private void requestLocationPermissionForUpVersion() {
        // 如果裝置版本是6.0（包含）以上
    ...
    public void mark()
    {
        ...
        for(int i = 0; i < longitude.size(); i++) {
            ...
            {
                points.add(new LatLng(Double.valueOf(latitude.get(i)), Double.valueOf(longitude.get(i))));
